...
public class UserService {
                            ...
                            .flatMap(firebaseUser -> {
                                ...
                                return Mono.fromCallable(() -> {
                                    FirebaseAuth.getInstance().setCustomUserClaims(uid,
                                            Map.of("role", primaryRole.toUpperCase()));
                                    return uid;
                                });
                            })
                            .flatMap(uid -> {
    ...
    public Mono<UserDto> changeEmail(String firebaseUid, String newEmail) {
        return usersRepository.findAll()
                ...
                .next()
                .switchIfEmpty(Mono.error(new RuntimeException("Usuario no encontrado")))
                .flatMap((User user) -> usersRepository.findByEmail(newEmail)
    ...
    /**
     * Permite al usuario editar su propio perfil sin cambiar email, password ni
     * rol.
     */
